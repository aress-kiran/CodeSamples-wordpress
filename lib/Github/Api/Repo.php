...
class Repo extends AbstractApi
{
    ...
    public function readme($username, $repository)
    {
		...
		/**
     * Get the events for perticular repository
     * @link http://developer.github.com/v3/repos/contents/#get-the-readme
     *
     * @param string $username   the user who owns the repository
     * @param string $repository the name of the repository
     ...
     * @return array events
     */
		public function repo($username, $repository, $type = "events")
    {
        return $this->get('repos/'.rawurlencode($username).'/'.rawurlencode($repository).'/'.$type);
    }
